 ...
 */
package org.shopping.backoffice.jalo;
...
import org.shopping.backoffice.constants.ShoppingBackofficeConstants;
...
public class ShoppingBackofficeManager extends GeneratedShoppingBackofficeManager
{
	...
	private static final Logger LOG = Logger.getLogger(ShoppingBackofficeManager.class.getName());
