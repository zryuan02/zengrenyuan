 ...
 */
package de.hybris.platform.shoppingbackoffice.actions;
...
public class ConfirmPickupAction implements CockpitAction<ConsignmentModel, Object>
{
	...
	private static final String CONFIRM_PICKUP_EVENT = "shoppingbackoffice.confirmpickup.event";
	...
	{
		return ctx.getData().getStatus().equals(ConsignmentStatus.READY_FOR_PICKUP);
	}
