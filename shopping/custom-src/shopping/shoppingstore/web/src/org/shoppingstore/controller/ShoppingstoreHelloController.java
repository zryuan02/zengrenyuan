 ...
 */
package org.shoppingstore.controller;
...
@Controller
public class ShoppingstoreHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", shoppingstoreService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
