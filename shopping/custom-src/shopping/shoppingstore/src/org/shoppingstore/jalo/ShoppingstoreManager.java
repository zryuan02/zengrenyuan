 ...
 */
package org.shoppingstore.jalo;
...
/**
 * This is the extension manager of the Shoppingstore extension.
 */
public class ShoppingstoreManager extends GeneratedShoppingstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ShoppingstoreManager.class);
	 ...
	 */
	public static ShoppingstoreManager getInstance()
	{
		return (ShoppingstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ShoppingstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ShoppingstoreManager() // NOPMD 
	{
		LOG.debug("constructor of ShoppingstoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ShoppingstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ShoppingstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
