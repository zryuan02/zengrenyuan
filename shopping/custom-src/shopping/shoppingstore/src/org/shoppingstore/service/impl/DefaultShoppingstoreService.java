...
public class DefaultShoppingstoreService implements ShoppingstoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultShoppingstoreService.class);
	...
	{
		return DefaultShoppingstoreService.class.getResourceAsStream("/shoppingstore/sap-hybris-platform.png");
	}
